...
<head>
  ...
  <title>Find Answer</title>
</head>
<body>
  <h1>Find Answer</h1>
  <form id="findAnswerForm">
    <label for="answerId">Answer ID:</label>
    <input type="text" id="answerId" name="answerId" required>
    <button type="button" onclick="findAnswer()">Find</button>
  </form>
  ...
  <script>
    function findAnswer() {
      ...
      xhr.open('GET', 'find_answer.php?answerId=' + answerId, true);
